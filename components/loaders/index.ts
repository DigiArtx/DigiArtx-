...
}>(({ size = 20, width = "100%", background = "transparent" }) => ({
  width,
...
export const LoadingAvatar = styled(FadeLoading)<{
  height?: number;
  width?: number;
  radius?: number;
  right?: number;
}>(({ height = 60, width = 60, radius = width * 2, right = 15 }) => ({
...
export const LoadingText = styled(FadeLoading)<{
  height?: number;
  width?: number;
  bottom?: number;
  right?: number;
}>(({ height = 16, width = 100, bottom = 6, right = 15 }) => ({
  height: heightPixel(height),
  width: widthPixel(width),
  borderRadius: 20,
...
export const LoadingBox = styled(FadeLoading)<{
  height?: number;
  width?: number;
  bottom?: number;
  right?: number;
